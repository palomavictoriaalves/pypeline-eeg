...
PROCESSED_DIR = RESULTS_DIR / "processed"   # preprocessing outputs
...
# Channels to include (opcional, usado neste script)
ACTIVE_CHANNELS = {
    "Fp1","Fp2",
    "F7","F3","Fz","F4","F8",
    "FC5","FC1","FC2","FC6",
...
# Use 'REGIONS' como definição de ROI para os gráficos de timeseries
REGIONS = {
    "Prefrontal":      ["Fp1","Fp2"],
